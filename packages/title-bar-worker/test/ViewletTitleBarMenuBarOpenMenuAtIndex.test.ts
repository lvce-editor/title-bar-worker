...
test('openMenuAtIndex opens overflow menu with hidden top-level entries', async () => {
  const state: TitleBarMenuBarState = {
    ...
    iconWidth: 30,
    titleBarEntries: [
      { command: '', flags: MenuItemFlags.None, id: MenuEntryId.File, label: 'File', width: 50 },
      { command: '', flags: MenuItemFlags.None, id: MenuEntryId.Edit, label: 'Edit', width: 50 },
      { command: '', flags: MenuItemFlags.None, id: MenuEntryId.View, label: 'View', width: 40 },
      { command: '', flags: MenuItemFlags.None, id: MenuEntryId.Help, label: 'Help', width: 40 },
    ],
    titleBarHeight: 30,
    width: 140,
    x: 10,
